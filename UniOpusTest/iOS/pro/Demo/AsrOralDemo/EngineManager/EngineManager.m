...
-(id)init
{
    if (self = [super init])
    {
        ...
        [stateMachine reset];
        watcher = [[PerformanceWatcher alloc]init];
    }
...
-(void)startRecognize
{
    ...
    [watcher addTimeWatcherWithName:@"→ startRecognize"];
...
-(void)stopRecognize
{
    ...
    [watcher addTimeWatcherWithName:@"→ stopRecognize"];
...
- (void)onBeginOral
{
    ...
    [watcher addTimeWatcherWithName:@"onBeginOral"];
...
- (void)onStopOral
{
    ...
    [watcher addTimeWatcherWithName:@"onStopOral"];
...
- (void)onResult:(NSString *)result isLast:(BOOL)isLast
{
    ...
    [watcher addTimeWatcherWithName:@"onResult"];
...
{
    [watcher addTimeWatcherWithName:@"onEndOral"];
    [watcher finishDiscription];
...
- (void)onVADTimeout
{
    ...
    [watcher addTimeWatcherWithName:@"onVADTimeout"];
...
- (void)oralEngineDidInit:(NSError *)error
{
    ...
    [watcher addTimeWatcherWithName:@"oralEngineDidInit"];
...
- (void)audioFileDidRecord:(NSString *)url
{
    ...
    [watcher addTimeWatcherWithName:@"audioFileDidRecord"];
...
- (void)onAsyncResult:(NSString *)url
{
    ...
    [watcher addTimeWatcherWithName:@"onAsyncResult"];
