    ...
    dispatch_async(encodeQue, ^{
        ...
        if (!isCanceled)
        {
            ...
            dispatch_async(dispatch_get_main_queue(), ^{
                ...
                USCLog(@"UniOpus -> encode : %ld |encodeNum : %ld| isStop : %d | isCanceled : %d",(long)audioDataAry.count, (long)encodeNum, isStoped, isCanceled);
